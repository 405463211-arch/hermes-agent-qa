...
#
# ``video`` is an upstream v0.13.0 addition (PR introducing the
# ``ascii-video`` toolset). Kept off by default upstream-side because
# the experience requires a TUI / terminal capable of high-throughput
# rendering — fold it into the same set here.
_DEFAULT_OFF_TOOLSETS = {
    "moa", "homeassistant", "rl", "spotify", "discord", "discord_admin",
    # Upstream v0.13.0 addition.
    "video",
